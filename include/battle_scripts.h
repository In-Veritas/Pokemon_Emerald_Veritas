...
extern const u8 BattleScript_BabyCharmActivatesEnd3[];
extern const u8 BattleScript_BabyCharmActivates[];
extern const u8 BattleScript_QuickLearnerActivates[];
extern const u8 BattleScript_MysticTempoActivates[];
...
extern const u8 BattleScript_PrintPickupStringVowelItem[];
