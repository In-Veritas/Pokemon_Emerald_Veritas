...
extern const u8 gText_Lv50Battle[];
extern const u8 gText_Lv50DoubleBattle[];
extern const u8 gText_Lv50MultiBattle[];
extern const u8 gText_BerryCrush3[];
extern const u8 gText_Minigames[];
...
extern const u8 gText_RegisteredTrainerInPokenav[];
extern const u8 gText_LinkMusic_VsTrainer[];
extern const u8 gText_LinkMusic_VsRival[];
extern const u8 gText_LinkMusic_VsGymLeader[];
...
extern const u8 gText_LinkMusic_VsEliteFour[];
extern const u8 gText_LinkMusic_Shadow[];
extern const u8 gText_LinkMusic_VsFriends[];
