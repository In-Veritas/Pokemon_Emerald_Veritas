...
extern const u8 gPokeNewsTextShinyDay_Upcoming[];
extern const u8 gPokeNewsTextShinyDay_Ongoing[];
extern const u8 gPokeNewsTextShinyDay_Ending[];
extern const u8 gPokeNewsTextTrainingDay_Upcoming[];
extern const u8 gPokeNewsTextTrainingDay_Ongoing[];
extern const u8 gPokeNewsTextTrainingDay_Ending[];
...
extern const u8 EventScript_InvalidRecordsCleaned[];
