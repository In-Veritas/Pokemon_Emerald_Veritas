...
u8 OverworldSpeedup_AdditionalIterations(u16 speed, bool32 overworld)
{
    ...
    switch (speed)
    {
        case OPTIONS_OVERWORLD_SPEED_8X: return OPTIONS_OVERWORLD_SPEED_1X_EXTRA_ITERATIONS;
        case OPTIONS_OVERWORLD_SPEED_4X: return OPTIONS_OVERWORLD_SPEED_1X_EXTRA_ITERATIONS;
        case OPTIONS_OVERWORLD_SPEED_2X: return OPTIONS_OVERWORLD_SPEED_1X_EXTRA_ITERATIONS;
