...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
    ...
    {
        // Fast surf: ~30% slower than running (6 frames vs 4 frames per tile)
        if (
            ...
            PlayerRideWaterCurrent(direction);  // Uses MOVE_SPEED_FAST_2 (6 frames) - 33% slower than MOVE_SPEED_FASTER
