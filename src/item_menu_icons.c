...
const struct CompressedSpriteSheet gBagRsMaleSpriteSheet =
{
    gBagRsMaleTiles, 0x3000, TAG_BAG_GFX
};

const struct CompressedSpriteSheet gBagRsFemaleSpriteSheet =
{
    gBagRsFemaleTiles, 0x3000, TAG_BAG_GFX
};
