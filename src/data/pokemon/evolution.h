const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_HAUNTER]    = {{EVO_TRADE, 0, SPECIES_GENGAR},
                            {EVO_LEVEL, 70, SPECIES_GENGAR}},
    [SPECIES_ONIX]       = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX},
                            {EVO_ITEM_LEVEL, EVO_ITEM_LEVEL_PARAM(ITEM_METAL_COAT, 60), SPECIES_STEELIX}},
    ...
    [SPECIES_SEADRA]     = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
                            {EVO_ITEM_LEVEL, EVO_ITEM_LEVEL_PARAM(ITEM_DRAGON_SCALE, 60), SPECIES_KINGDRA}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                            {EVO_ITEM_LEVEL, EVO_ITEM_LEVEL_PARAM(ITEM_METAL_COAT, 60), SPECIES_SCIZOR}},
    ...
    [SPECIES_PORYGON]    = {{EVO_TRADE_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2},
                            {EVO_ITEM_LEVEL, EVO_ITEM_LEVEL_PARAM(ITEM_UP_GRADE, 40), SPECIES_PORYGON2}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_TRADE_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                            {EVO_ITEM_LEVEL, EVO_ITEM_LEVEL_PARAM(ITEM_DEEP_SEA_TOOTH, 60), SPECIES_HUNTAIL},
                            {EVO_TRADE_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS},
                            {EVO_ITEM_LEVEL, EVO_ITEM_LEVEL_PARAM(ITEM_DEEP_SEA_SCALE, 60), SPECIES_GOREBYSS}},
